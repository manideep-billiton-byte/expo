                ...
                return (
                    <div className="dashboard-container">
                        ...
                        <div className="stats-grid fade-in">
                            <StatsCard label="Active Tenants" value="248" change="+12 this month" icon={Building2} colorClass="text-blue-500" customClass="stat-card-blue" />
                            <StatsCard label="Active Events" value="42" change="8 ongoing" icon={Calendar} colorClass="text-emerald-500" customClass="stat-card-green" />
                            <StatsCard label="Total Exhibitors" value="1,847" change="+150 this week" icon={ImageIcon} colorClass="text-purple-500" customClass="stat-card-purple" />
                            <StatsCard label="Registered Visitors" value="24,582" change="+2,340 today" icon={Users} colorClass="text-blue-400" customClass="stat-card-blue" />
                            <StatsCard label="Leads Captured" value="18,429" change="+842 today" icon={MousePointer2} colorClass="text-orange-500" customClass="stat-card-orange" />
                            ...
                            <StatsCard label="Revenue (MTD)" value="₹12.4L" change="+15% vs last month" icon={IndianRupee} colorClass="text-emerald-600" customClass="stat-card-emerald" />
                        ...
                        <div className="card fade-in" style={{ marginBottom: '24px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '16px' }}>
                                {[
                                    ...
                                    { label: 'Leads', value: '1000', customClass: 'activity-orange', textColor: '#f59e0b' },
                                    { label: 'Visitors', value: '15000', customClass: 'activity-red', textColor: '#dc2626' },
                                    { label: 'Revenue', value: '10,00,000', customClass: 'activity-green', textColor: '#16a34a' }
                                ].map((item, idx) => (
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1.8fr 1fr', gap: '24px', marginBottom: '24px' }} className="fade-in">
                                                ...
                                                <tr key={idx}>
                                                    ...
                                                    <td>
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                                            <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: row.status === 'Active' ? '#10b981' : '#f59e0b' }}></div>
                                                            <span style={{ fontSize: '12px', fontWeight: 600, color: row.status === 'Active' ? '#10b981' : '#f59e0b' }}>{row.status}</span>
                                                        </div>
                                                    </td>
                            ...
                            <div className="card">
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    {[
                                        { label: 'API Gateway', status: '99.98%', color: '#10b981' },
                                        { label: 'Database', status: '99.91%', color: '#10b981' },
                                        { label: 'WhatsApp Service', status: '99.88%', color: '#10b981' },
                                        { label: 'Email Service', status: '99.58%', color: '#f59e0b' },
                                        { label: 'SMS Gateway', status: '99.94%', color: '#10b981' }
                                    ].map((item, idx) => (
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', marginBottom: '24px' }} className="fade-in">
                            <div className="card">
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                    <div style={{ textAlign: 'center' }}>
                                        <div style={{ fontSize: '20px', fontWeight: 800, color: '#1e293b' }}>94.5%</div>
                                        <div style={{ fontSize: '10px', color: '#94a3b8' }}>Consent Rate</div>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <div style={{ fontSize: '20px', fontWeight: 800, color: '#1e293b' }}>3</div>
                                        <div style={{ fontSize: '10px', color: '#94a3b8' }}>Complaints</div>
                                    </div>
                                </div>
                            </div>
                            <div className="card">
                            ...
                            <div className="card">
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px' }}>
                                        <span style={{ color: '#64748b' }}>Active Paid</span>
                            ...
                            <div className="card">
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                                    <div style={{ background: '#f8fafc', padding: '8px', borderRadius: '8px', textAlign: 'center', cursor: 'pointer' }}>
                                        <Plus size={14} color="#64748b" />
                                        <div style={{ fontSize: '9px', fontWeight: 600, color: '#64748b', marginTop: '4px' }}>Event</div>
                                    </div>
                                    <div style={{ background: '#f8fafc', padding: '8px', borderRadius: '8px', textAlign: 'center', cursor: 'pointer' }}>
                                        <UserPlus size={14} color="#64748b" />
                                        <div style={{ fontSize: '9px', fontWeight: 600, color: '#64748b', marginTop: '4px' }}>User</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card fade-in" style={{ marginBottom: '24px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                {[
                                    { text: 'High WhatsApp usage for TechCorp India - 85% quota used', color: '#f59e0b', bg: '#fffaf0' },
                                    { text: 'Payment failed for StartupHub subscription renewal', color: '#f43f5e', bg: '#fef2f2' },
                                    { text: 'New tenant registration request: EventPro Global Solutions', color: '#2563eb', bg: '#f0f7ff' }
                                ].map((alert, idx) => (
                                    <div key={idx} style={{ background: alert.bg, border: '1px solid #f1f5f9', padding: '12px 16px', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '12px' }}>
